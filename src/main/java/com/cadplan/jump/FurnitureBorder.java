...
public class FurnitureBorder extends Furniture
{
     ...
     * @param x x value of the point to test
     * @param y y value of the point to test
     * @param scale furnitureScale
     * @param globalScale global scale (default = 1.0)
     * @return if the point is inside the drag square or not
     */
     ...
     * @param x new x of the furniture location
     * @param y new y of the furniture location
     * @param w new width of the furniture location
     * @param h new height of the furniture location
     * @param force whether a forced change is required or not
     */
