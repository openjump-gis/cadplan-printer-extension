 ...
 * TODO : very repetitive code. Thanks to Furniture interface and its location attribute
 *        it may be possible to have a list of Furnitures and process them iterativly
 *        with more generic methods [mmichaud 2021-04-17]
 */
public class PrinterPreview extends JPanel implements MouseListener, MouseMotionListener, Comparator
{
    ...
    public PrinterPreview( PlugInContext context)
    {
        ...
        try
        {
            ...
            if(debug) sb.append("Viewport: "+ viewPort +"  visRect: "+visRect.toString()+"\n");
