...
public class FurnitureNotePanel extends JPanel implements ActionListener {
  ...
  FurnitureNote note;
  TextArea textField;
  JComboBox<String> fontNameCombo, fontSizeCombo, fontStyleCombo, justifyCombo;
  ...
  public FurnitureNotePanel(Vector<FurnitureNote> notes) {
    this.notes = notes;
    styles = new String[]{
        i18n.get("JumpPrinter.Furniture.Note.Plain"),
        i18n.get("JumpPrinter.Furniture.Note.PlainItalic"),
        i18n.get("JumpPrinter.Furniture.Note.Bold"),
        i18n.get("JumpPrinter.Furniture.Note.BoldItalic")};
    sizes = new String[]{"6", "7", "8", "9", "10", "12", "14", "16", "18", "20", "24", "28", "32", "36", "48", "64", "72", "84", "96"};
    justifies = new String[]{
        i18n.get("JumpPrinter.Furniture.Note.Left"),
        i18n.get("JumpPrinter.Furniture.Note.Centre"),
        i18n.get("JumpPrinter.Furniture.Note.Right"),
        i18n.get("JumpPrinter.Furniture.Note.Full")};
  ...
  public void init() {
    ...
    textLabel = new JLabel(i18n.get("JumpPrinter.Furniture.Note.Note"));
    gb.setPosition(0, 1);
    ...
    fontLabel = new JLabel(i18n.get("JumpPrinter.Furniture.Note.Font"));
    gb.setPosition(0, 2);
    gb.setInsets(10, 10, 0, 0);
    ...
    bcolorCB = new JCheckBox(i18n.get("JumpPrinter.Furniture.Note.Shade"));
    gb.setPosition(3, 3);
    ...
    borderCB = new JCheckBox(i18n.get("JumpPrinter.Furniture.Note.Border"));
    gb.setPosition(5, 3);
    gb.setInsets(10, 0, 0, 0);
    ...
    JLabel widthLabel = new JLabel(i18n.get("JumpPrinter.Furniture.Note.Width"));
    gb.setPosition(1, 0);
    gb.setInsets(10, 0, 0, 0);
    //gb.setAnchor(GridBagConstraints.EAST);
    ...
    deleteB = new JButton(i18n.get("JumpPrinter.Furniture.Note.Delete"));
    gb.setPosition(4, 5);
    ...
    addB = new JButton(i18n.get("JumpPrinter.Furniture.Note.Add"));
    gb.setPosition(6, 5);
  ...
  public void actionPerformed(ActionEvent ev) {
    ...
    if (ev.getSource() == deleteB) {
      ...
      int result = JOptionPane.showConfirmDialog(this,
          i18n.get("JumpPrinter.Furniture.Note.Message1"));
  ...
  private String styleString(int style) {
    String s;
    if (style == Font.PLAIN) s = i18n.get("JumpPrinter.Furniture.Note.Plain");
    else if (style == Font.BOLD) s = i18n.get("JumpPrinter.Furniture.Note.Bold");
    else if (style == (Font.PLAIN + Font.ITALIC)) s = i18n.get("JumpPrinter.Furniture.Note.PlainItalic");
    else s = i18n.get("JumpPrinter.Furniture.Note.BoldItalic");
    return s;
  }

  private int styleNumber(String style) {
    int n;
    if (style.equals(i18n.get("JumpPrinter.Furniture.Note.Plain"))) n = Font.PLAIN;
    else if (style.equals(i18n.get("JumpPrinter.Furniture.Note.Bold"))) n = Font.BOLD;
    else if (style.equals(i18n.get("JumpPrinter.Furniture.Note.PlainItalic"))) n = (Font.PLAIN + Font.ITALIC);
