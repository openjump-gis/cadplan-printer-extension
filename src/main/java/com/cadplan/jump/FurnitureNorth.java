...
//             g.drawString("N", lx+w/2-20, ly+t+20);
            ...
            // TODO wt & ht unused : should following location.width and height use wt and ht ?
    ...
    public void paint(Graphics g, double scale)
    {
        ...
        int xo = location.x + location.width/2;
        int yo = location.y + location.height/2;
        ...
        drawNorth(g, location.x, location.y, type);
