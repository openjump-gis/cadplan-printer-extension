...
public class FurnitureImagePanel extends JPanel
  ...
  public FurnitureImagePanel(FurnitureDialog parent, Vector<FurnitureImage> imageItems) {
  ...
  public void init() {
    ...
    fileNameLabel = new JLabel(i18n.get("JumpPrinter.Furniture.Image.ImageFile"));
    gb.setPosition(1, 0);
    ...
    lockedLabel = new JLabel(i18n.get("JumpPrinter.Furniture.Image.Locked"));
    gb.setPosition(4, 0);
